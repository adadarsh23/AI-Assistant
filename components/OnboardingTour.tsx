    ...
    <div className="fixed inset-0 z-[10000]">
      ...
      <AnimatePresence>
        <motion.div
          ...
          ref={tooltipRef}
          className="absolute w-[calc(100%-2rem)] max-w-sm rounded-lg border border-white/20 bg-gray-800 text-white shadow-2xl shadow-black/50 p-4"
          style={style}
        ...
        >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handleNext}
                className="px-3 py-1 text-sm bg-gray-200 hover:bg-gray-300 text-black rounded-md transition-colors"
              >
